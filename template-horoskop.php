 ...
 * Template Name: Template Horoskop
...
<div id="cd_vesti_title">HOROSKOP<div id="izaberi_kat">
...
<div class="cat_vesti">Kategorije</div><br/>

<ul class="unstyled">
<li><span class="icon12 typ-icon-arrow-right red"></span><a href="<?php echo get_category_link($cat=2124);?>">Nedeljni horoskop (<?php echo wp_get_cat_postcount(2124); ?>)</a></li>
<li><span class="icon12 typ-icon-arrow-right red"></span><a href="<?php echo get_category_link($cat=2125);?>">Mesecni horoskop (<?php echo wp_get_cat_postcount(2125); ?>)</a></li>
<li><span class="icon12 typ-icon-arrow-right red"></span><a href="<?php echo get_category_link($cat=2126);?>">Astro konsultacije (<?php echo wp_get_cat_postcount(2126); ?>)</a></li>
</ul>
<div style="clear:both"></div>
</div>
</div>
