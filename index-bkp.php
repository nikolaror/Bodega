...
<div id="brendingL">
    <a href="https://play.google.com/store/apps/details?id=com.us.chicagodesavanja.android&hl=en" target="_blank">
        <img src="<?php bloginfo('template_url'); ?>/images/reklama_left.png" alt="" />
    </a>
</div>
<div id="brendingR">
    <a href="https://itunes.apple.com/us/app/chicago-desavanja/id653715847?ls=1&mt=8" target="_blank">
        <img src="<?php bloginfo('template_url'); ?>/images/reklama_right.png" alt="" />
    </a>
</div>
...
<div class="desavanja_pocetna_txt"><a href="<?php echo get_page_link($cat=17);?>">Desavanja</a></div>	
							<ul class="nav nav-pills">
								<li class='active'>
									<a href="#3" data-toggle="tab" onclick="javascript:testScroll();" 
class="onClickUpdate">Predstojeca desavanja</a>
								</li>
								<li>
									<a href="#4" data-toggle="tab" onclick="javascript:testScroll();" 
class="onClickUpdate">Najnoviji unosi</a>
								</li>
							</ul>
...
<!-- //** DESAVANJA POCETNA KRAJ **// -->

<div id="reklamni_prostor_620">

<div id="reklamni_620_pomeranje">

<?php

      if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('reklamni-620') ) :
...
<div id="reklamni_prostor_hdr">

<div class="izdvajamo_pocetna_txt">Reklamni Prostor</div><div id="pd"></div>

<a href="http://www.styletravelusa.com/" target="_blank"><img src="<?php echo get_bloginfo('template_directory');?>/images/300x250.jpg"/></a>
...
<img src="http://chicagodesavanja.us/wp-content/uploads/2013/09/midbaner-darasako.jpg"/>

<a href="http://chicagodesavanja.us/adresar/prehrana/kikos-market-restoran/"><img src="<?php echo get_bloginfo('template_directory');?>/images/457x60-2.png"/></a>
...
$( "a.onClickUpdate" ).live( "click", function() {
initDesavanjaSlider();
initIzdvajamoSlider();
});
