...
<div class="desavanja_pocetna_txt"><a href="<?php echo get_page_link($cat=17);?>">Desavanja</a></div>	
							<ul class="nav nav-pills">
								<li class='active'>
									<a href="#3" data-toggle="tab" onclick="javascript:testScroll();">Predstojeca desavanja</a>
								</li>
								<li>
									<a href="#4" data-toggle="tab" onclick="javascript:testScroll();">Najnoviji unosi</a>
								</li>
							</ul>
...
<a href="http://chicagodesavanja.us/adresar/klubovi-kafici-barovi/sunset-caffe/"><img src="<?php echo get_bloginfo('template_directory');?>/images/457x60-1.png"/></a>
