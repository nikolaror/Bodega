 ...
 * Template Name Posts: Info Single
 */
?>
...
<div id="cd_adresar_title"><div id="naslov_gal">CHICAGO DESAVANJA - INFO</div>
<div id="izaberi">
 <div class="btn-group">
										...
										<li><a href="<?php echo get_category_link($cat=957);?>">Domace knjige</a></li>
                                        <li> <a href="<?php echo get_category_link($cat=958);?>">Strane knjige</a></li>
                                        <li> <a href="<?php echo get_category_link($cat=959);?>">Film</a></li>
                                        <li> <a href="<?php echo get_category_link($cat=960);?>">Serije</a></li>
                                        <li> <a href="<?php echo get_category_link($cat=961);?>">Korisne informacije</a></li>
                                        </ul>
                                    </div>
...
<div class="predstojeca_vesti_txt">Poslednje Informacije</div>
<div class="poslednje_gal_desno"><a href="<?php echo get_category_link($cat=955);?>">INFO</a></div>
<div style="clear:both"></div>
<div id="ppaa">
<div class="scroll" style="height:185px; width:302px; overflow:auto; margin-top:10px;">
<?php query_posts('showposts=10&cat=955'.'&offset=0'); if (have_posts()) : ?>
