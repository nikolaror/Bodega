...
<div id="dodavanja" class="dodavanje"><a href="<?php echo get_page_link($cat=126);?>">Dodaj desavanje</a> | <a href="<?php echo get_page_link($cat=128);?>" class="dodajOglas">Dodaj oglas</a>   </div>
