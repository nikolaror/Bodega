...
class workz_flickr extends WP_Widget {
	
	function workz_flickr() {
		...
		// register the widget
		$this->WP_Widget('workz_flickr', __('Flickr'), $widget_ops);
...
add_action('widgets_init', create_function('', 'return register_widget("workz_flickr");'));	
?>